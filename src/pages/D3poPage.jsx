            ...
            <main className="container mx-auto px-6 py-12">
                ...
                <section className="text-center py-16 mb-12 rounded-xl bg-slate-100 dark:bg-slate-800 relative overflow-hidden transition-colors duration-300">
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="text-xl md:text-2xl font-bold text-slate-700 dark:text-slate-200 mb-8 max-w-4xl mx-auto">
                        ...
                        <p className="text-lg text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed mb-10">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-4">
                            <a href="https://openreview.net/forum?id=iH7mSOTR4q" className="inline-flex items-center justify-center gap-2 bg-blue-600 text-white font-semibold px-8 py-3 rounded-lg hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-blue-500/30" rel="noopener noreferrer" target="_blank">
                                <FileText size={20} />
                                <span>Read Paper</span>
                            </a>
                            <a href="https://github.com/TanmayAmbadkar/reward-decomposition" className="inline-flex items-center justify-center gap-2 bg-slate-800 text-white font-semibold px-8 py-3 rounded-lg hover:bg-slate-900 transition-all duration-300 shadow-lg hover:shadow-slate-500/30" rel="noopener noreferrer" target="_blank">
                                <Github size={20} />
                                <span>View Code</span>
                            </a>
                        </div>
