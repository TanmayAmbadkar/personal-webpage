...
const RampsBlogPage = () => {
    ...
    return (
        <div className="font-sans bg-slate-50 text-slate-900 min-h-screen antialiased" ref={contentRef}>
            <SEO
                title="RAMPS: Deep Dive Blog Post"
                description="A detailed technical deep dive into RAMPS (Robust Adaptive Multi-Step Predictive Shielding) for safe reinforcement learning."
                keywords="RAMPS, Safe RL, Control Barrier Functions, Koopman Operator, Reinforcement Learning Blog"
            />
            {/* Header */}
